...
**Reviewer T1–T7 ("you do not need to trust us; run these seven things"):** T1 clean→`0` · T2 strip proof→`1`(`31`) · T3 corrupt signature→`1`(`32`) · T4 replay stale proof→`1`(`33`) · T5 untrusted-authority→`1`(`34`, killer invariant) · T6 action mismatch→`1`(`35`) · T7 under-declared authority sink→`1`(`38`).
