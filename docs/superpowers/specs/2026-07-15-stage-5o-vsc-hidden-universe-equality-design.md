...
| S3.5  | case canonicalisation variant                                                        | same digest **only** when the parsed values produce identical bytes under the frozen schema and canonicalisation algorithm              | `implementation_regression_fixtures` |
...
| S4.45 | same seventeen pairs, different order in object versus preimage                                            | **negative implementation fixture** — order is frozen; two orderings would be two canonical forms                                                    | `implementation_regression_fixtures` |
...
| S4.49 | a Section 6 profile omitted from the bundle                                                                | **reject** — seventeen pairs mandatory; an absent pin is an unbound construction                                                                     | `evidence_attack_fixtures`           |
...
| S4.52 | old seven-pair `profile_bundle_digest` presented with the new seventeen-pair object                        | **reject** — recomputation mismatch; this is A17's defect presented as evidence                                                                      | `evidence_attack_fixtures`           |
