...
| **Pinned limits cannot contradict one another — proven, not sampled**                     | ✅ 4.1.1 — limit-compatibility invariant derived from the frozen canonical schema; closed-form (leaf vector exact in `N`); worst case 6,809,136 <= 8,388,608 bytes, 1,579,472 B (1.506 MiB) headroom, recomputed at A9, A11, A17, A18, A19 and independently generator-derived at A27; canonical <= transport                                                                          |
...
| **Sizing counts ALL public objects, not the manifest alone (A11)**                        | ✅ 4.1.1 — public canonical core 45,191,912 B (43.098 MiB) = manifest 6,809,136 (A27, generator-derived) + exec census 19,191,389 + result census 19,191,387; stated as an evidence footprint, never a heap bound                                                                                                                                                                      |
