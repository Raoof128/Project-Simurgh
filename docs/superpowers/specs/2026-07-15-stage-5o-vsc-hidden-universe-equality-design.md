...
| **Sizing counts ALL public objects, not the manifest alone (A11)**                        | ✅ 4.1.1 — public canonical core 45,648,155 B (43.533 MiB) = manifest 7,265,379 + exec census 19,191,389 + result census 19,191,387; stated as an evidence footprint, never a heap bound                                                                       |
