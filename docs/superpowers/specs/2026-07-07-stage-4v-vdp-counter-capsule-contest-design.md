...
literature-complete novelty claim. (The third axis was labelled
"Good-for-Anthropic" in earlier stages; renamed here to the
provider-agnostic "Lab/regulator usefulness" per the public-wording rail —
same axis, scores remain cross-stage comparable.)
...
| Lab/regulator usefulness | 9.4   | Due process is the missing half of the regulator wedge — reports a lab files (or is named in) become answerable, not just assertable. Higher: real-regime pilot.                                                                                                                                                                                                                 |
