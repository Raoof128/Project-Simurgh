...
> **Status (v0.4.3, 2026-05-15):** This document describes the Stage 1 boundary as published in the Stage 1.5 reviewer pack. Stage 2.1 (macOS integrity proofs) and Stage 2.2 (macOS node pairing) are now merged; for Stage 2 limitations see [`STAGE_2_ARCHITECTURE.md`](stages/STAGE_2_ARCHITECTURE.md) and `SECURITY.md`.
