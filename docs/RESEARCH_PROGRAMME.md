...
- **Browser is fundamentally untrusted.** A page can lie about everything: focus state, fullscreen, capture state, paste contents, even keystroke timing. Simurgh Stage 1 treated these as risk _signals_, not as proof — that posture survives into Stage 2.
