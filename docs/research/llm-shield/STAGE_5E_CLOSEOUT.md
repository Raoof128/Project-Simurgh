...
## Honest re-score (spec-time: Novelty 9.5 / Frontier 9.3→9.6 / Good-for-Anthropic 9.6 / Constitution 9.6)
...
| **Frontier**           | 9.3  | **9.6**      | **The capture EXECUTED** — real gated Prompt Guard 2, pinned revision, offline; plus a cross-arch droplet reproduction. Held at 9.6: no external **party** has run the BYO adapter (the 10 lever). |
...
5. **Independent environment, not independent party.** The droplet reproduction banks Frontier ~9.6; a
   real external party running the BYO adapter is the reserved path to 10.
