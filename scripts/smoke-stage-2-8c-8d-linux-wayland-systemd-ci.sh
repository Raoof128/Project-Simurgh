...
PORT="${SIMURGH_STAGE28CD_PORT:-33130}"
LOG_DIR="${SIMURGH_SMOKE_LOG_DIR:-.simurgh_check_logs/stage28cd-linux-wayland-systemd-ci}"
...
wait_for_health() {
  ...
  echo "Stage 2.8C/D smoke failed: server did not become healthy" >&2
