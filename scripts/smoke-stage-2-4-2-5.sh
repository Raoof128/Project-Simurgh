...
wait_for_health "http://127.0.0.1:$OPTIONAL_PORT/health" "daemon-optional server" "$OPTIONAL_LOG"
wait_for_health "http://127.0.0.1:$HARDENED_PORT/health" "daemon-required server" "$HARDENED_LOG"
