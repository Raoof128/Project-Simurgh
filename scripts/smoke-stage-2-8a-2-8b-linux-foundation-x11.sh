...
PORT="${SIMURGH_STAGE28AB_PORT:-33128}"
LOG_DIR="${SIMURGH_SMOKE_LOG_DIR:-.simurgh_check_logs/stage28ab-linux-foundation-x11}"
...
wait_for_health() {
  ...
  echo "Stage 2.8A+2.8B smoke failed: server did not become healthy" >&2
