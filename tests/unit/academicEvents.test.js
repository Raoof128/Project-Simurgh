...
describe('academicEvents', () => {
  test('EVENTS exports all required taxonomy constants', () => {
    const required = [
      ...
      'TELEMETRY_WINDOW_RECEIVED', 'FOCUS_LOSS', 'LONG_TIME_OFF_WINDOW', 'BULK_PASTE',
      'REPEATED_PASTE', 'ABNORMAL_WPM_SPIKE', 'LONG_IDLE_GAP', 'CAPTURE_EXCLUDED_WINDOW',
      'RISK_ESCALATED', 'RISK_DEESCALATED', 'SESSION_RECONNECTED', 'EXAM_SUBMITTED',
      'REPORT_GENERATED', 'AUDIT_VERIFIED',
    ];
