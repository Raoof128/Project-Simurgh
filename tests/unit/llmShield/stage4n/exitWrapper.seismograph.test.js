...
test("raw 39 stays reserved and unknown codes fail closed to 3", () => {
  ...
  // are Stage 4S VDCC, 119-132 are Stage 4U VRTA codes (mapped to 1). Probe unknown ONLY
  // with UNKNOWN_RAW_PROBE (999) — never a bare literal just above the range.
  for (const raw of [39, 999, -1, undefined, null, "forty-seven"]) {
