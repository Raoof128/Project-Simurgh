...
test("wrapper stays total and fail-closed: unknown codes (incl. reserved 39) map to 3", () => {
  ...
  // 80-89 are Stage 4Q VFR codes, 90-99 are Stage 4R PCCC codes (all mapped to 1);
  // 39 stays reserved/unmapped, 100+ unknown.
  for (const raw of [39, 100, 999, -1, undefined, null, "thirty"]) {
