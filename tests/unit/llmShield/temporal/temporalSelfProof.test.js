...
test("each self-proof fixture trips its detector", () => {
  ...
  const cases = [
    { fixture_id: "clean-baseline", kind: "diff", expected_result: "accepted", expected_detector: null,
      payload: { row: { target_lineage_id: "a", diff_id: "d", created_at_utc: ts }, before: att("a", cell("contained")), after: att("a", cell("contained")) } },
    { fixture_id: "genuine-regression", kind: "diff", expected_result: "accepted", expected_detector: "regressed",
      payload: { row: { target_lineage_id: "a", diff_id: "d", created_at_utc: ts }, before: att("a", cell("contained")), after: att("a", cell("allowed")) } },
    { fixture_id: "genuine-improvement", kind: "diff", expected_result: "accepted", expected_detector: "improved",
      payload: { row: { target_lineage_id: "a", diff_id: "d", created_at_utc: ts }, before: att("a", cell("allowed")), after: att("a", cell("contained")) } },
    { fixture_id: "cross-lineage-diff", kind: "diff", expected_result: "rejected", expected_detector: "cross_target_diff_violation",
      payload: { row: { target_lineage_id: "a", diff_id: "d", created_at_utc: ts }, before: att("a", {}), after: att("a", {}), force_after_lineage: "b" } },
    { fixture_id: "corpus-mismatch", kind: "diff", expected_result: "non_comparable", expected_detector: "corpus_mismatch",
      payload: { row: { target_lineage_id: "a", diff_id: "d", created_at_utc: ts }, before: att("a", {}, "sha256:c1"), after: att("a", {}, "sha256:c2") } },
    { fixture_id: "before-integrity-failure", kind: "diff", expected_result: "accepted", expected_detector: "integrity_failure",
      payload: { row: { target_lineage_id: "a", diff_id: "d", created_at_utc: ts }, before: att("a", cell("verification_failed")), after: att("a", cell("allowed")) } },
    { fixture_id: "after-integrity-failure", kind: "diff", expected_result: "accepted", expected_detector: "integrity_failure",
      payload: { row: { target_lineage_id: "a", diff_id: "d", created_at_utc: ts }, before: att("a", cell("contained")), after: att("a", cell("verification_failed")) } },
    ...
    { fixture_id: "removed-entry-append", kind: "append_continuity", expected_result: "rejected", expected_detector: "append_continuity_violation",
      payload: { previousHead: { type: "simurgh.temporal.previous_registry_head.v1", stage: "3Q", previous_head_entry_digest: oldReg.head.head_entry_digest, previous_entry_count: 2 }, registry: shorter } },
    { fixture_id: "missing-created-at", kind: "manifest", expected_result: "rejected", expected_detector: "manifest_timestamp_violation",
      payload: { manifest: (() => { const m = manifest(1); delete m.snapshots[0].created_at_utc; return m; })() } },
    { fixture_id: "invalid-created-at", kind: "manifest", expected_result: "rejected", expected_detector: "manifest_timestamp_violation",
      payload: { manifest: (() => { const m = manifest(1); m.snapshots[0].created_at_utc = "2026-06-21 00:00:00"; return m; })() } },
  ];
