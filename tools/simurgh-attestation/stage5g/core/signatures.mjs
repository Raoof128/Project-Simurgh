...
// Stage 5G — VFC signatures. Low-level Ed25519 + canonical SPKI-DER fingerprint ONLY. Owns no policy
// (external-pin presence, subject/digest equality, and rung logic live in the check modules).
...
// Canonical SPKI-DER fingerprint (robust to PEM wrapping / line endings; works on a key extracted from a
// certificate). VFC-local convention — distinct from prior stages' raw-PEM keyDigest.
