...
// Stage 5J — VRC signatures. Low-level Ed25519 + canonical SPKI-DER fingerprint ONLY (ported from 5I).
// The pure vrcCore never touches crypto; the node adapter uses these to resolve `facts`.
