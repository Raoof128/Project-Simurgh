...
// Stage 5K VUC — Lane C: complete a DE-IDENTIFIED public-witness anchor. Runs `ots upgrade` + `ots
...
// binding: ANCHOR_ME.txt = universe_commitment_digest
...
export function verifyWitness(packDir, proofPath) {
  ...
  writeFileSync(target, bundle.universe_commitment.universe_commitment_digest + "\n");
