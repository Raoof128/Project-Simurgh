...
export const RUN_LEVEL_BY_RAW = Object.freeze({
  ...
  473: 1,
  474: 1,
  // Stage 5S — VWQ, band 475-512, allocation frozen in the 5S spec §2.7. Authorised by Annex M
  // row 5S-M004. Every code is a specific rejection at run level 1, EXCEPT the fail-closed wrapper.
  475: 1,
  476: 1,
  477: 1,
  478: 1,
  ...
  510: 1,
  511: 1,
  // 512 VWQ_UNKNOWN is the fail-closed wrapper and takes level 3, the same level this map already
  // assigns to any code it does not know. A wrapper that reported level 1 would claim the verifier
  // understood a failure it explicitly did not.
  512: 3,
});
