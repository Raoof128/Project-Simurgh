...
// Stage 5F VMP — deterministic panel constructor (single source for the evidence pack + reproduce).
// AnthropicSafe: a synthetic structural demonstration panel over two real detector identities; the REAL
// dual-detector capture is Lane C (non-CI, the Frontier lever). Byte-stable under a committed fixture key.
