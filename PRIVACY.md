...
**Last updated:** 2026-05-16 (Stage 2.6 Windows metadata-only scanner contract)
...
| Windows monitor-only / capture-excluded counts       | ✅                     | Stage 2.6 — signed `WDA_MONITOR` / `WDA_EXCLUDEFROMCAPTURE` counts |
